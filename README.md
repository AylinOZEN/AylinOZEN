...
Şu anki önceliğim, bu iki farklı disiplinde de yetkinlik kazanarak hem kullanıcı odaklı mobil çözümler üretmek hem de veri odaklı algoritmalar geliştirmektir.
...
| Alan | Detay |
| :--- | :--- |
| **Bölüm** | Bilişim Sistemleri ve Teknolojileri (3. Sınıf) |
| **Mobil Geliştirme** | **Flutter & Dart** ile cross-platform uygulama geliştirme süreçlerine odaklanıyorum. |
| **Yapay Zeka** | **Python** kullanarak veri analizi, temel makine öğrenmesi ve algoritmik çözümler üzerine çalışıyorum. |
| **Staj Hedefi** | Yazılım ve teknoloji odaklı şirketlerin mobil geliştirme veya AI departmanlarında görev alarak profesyonel deneyim kazanmak. |
...
* **Mobil Programlama:** Flutter & Dart (UI/UX Tasarımı ve temel uygulama mimarileri).
* **Veri & AI:** Python (Pandas, NumPy, Seaborn ve Scikit-learn ile veri işleme).
* **Güncel Teknik Müfredat:** Veri Madenciliği, Görsel Programlama (C#), Bilgi Güvenliği, Grafik Tasarım ve E-Ticaret.
